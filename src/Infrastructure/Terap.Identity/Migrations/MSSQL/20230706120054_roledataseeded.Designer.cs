...
namespace Terap.Identity.Migrations
{
    ...
    [Migration("20230706120054_roledataseeded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Terap.Identity.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Terap.Identity.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Terap.Identity.Models.ApplicationUser", b =>
                {
                    b.OwnsMany("Terap.Identity.Models.RefreshToken", "RefreshTokens", b1 =>
                        {
